...
# FRAME LOGIN
frame1 = Frame(root, height=250, width=250, highlightbackground='black', highlightthickness=3,bg='LightYellow3')
...
#CHECKBUTTON AND SPINBOX IN MENU
        ...
        l7 = Label(frame2, text="BEVERAGES", font=large_font3)
        l7.place(relx=0.53, rely=0.63)

        c23 = Checkbutton(frame2, text="Tea", variable=var23, font=large_font4, command=check23)
        c23.place(relx=0.53, rely=0.67)
        e23 = Spinbox(frame2, from_=0, to=10, width=10, state='disabled')
        e23.place(relx=0.81, rely=0.68)

        c24 = Checkbutton(frame2, text="Coffee", variable=var24, font=large_font4, command=check24)
        c24.place(relx=0.53, rely=0.72)
        e24 = Spinbox(frame2, from_=0, to=10, width=10, state='disabled')
        e24.place(relx=0.81, rely=0.73)
        p1 = StringVar()
        c25 = Checkbutton(frame2, text="Cold Coffee", variable=var25, font=large_font4, command=check25)
        ...
        c26 = Checkbutton(frame2, text="Chocolate Milkshake", variable=var26, font=large_font4, command=check26)
        c26.place(relx=0.53, rely=0.82)
        global e26
        e26 = Spinbox(frame2, from_=0, to=10, width=10, state='disabled')
        e26.place(relx=0.81, rely=0.83)

        c27 = Checkbutton(frame2, text="Oreo Milkshake", variable=var27, font=large_font4, command=check27)
        c27.place(relx=0.53, rely=0.87)
        e27 = Spinbox(frame2, from_=0, to=10, width=10, state='disabled')
        e27.place(relx=0.81, rely=0.88)

        c28 = Checkbutton(frame2, text="Soft Drinks", variable=var28, font=large_font4, command=check28)
        ...
        backmain=Button(top,text="Back",width=8, padx=4, pady=4,bg="LightYellow2",font=('Times', 15, 'bold'))
        ...
        def newwindow2():
            ...
            mainframe=Frame(top2,bd=10,width=1600,height=1600,relief=RIDGE,bg="lightYellow2")
            ...
            leftframe = Frame(topframe3, bd=5, width=770, height=400, padx=2,bg="lightYellow3",relief=RIDGE)
            leftframe.pack(side=LEFT)
            leftframe1 = Frame(leftframe, bd=5, width=600, height=180, padx=2,pady=4, relief=RIDGE)
            leftframe1.pack(side=TOP,padx=0,pady=0)

            rightframe1 = Frame(topframe3, bd=5, width=100, height=400, padx=2, bg="lightYellow3", relief=RIDGE)
...
#calculation of receipt
        ...
        def newwindow4():
            ...
            mainframe1 = Frame(top4, bd=10, width=770, height=700, relief=RIDGE, bg="lightYellow3")
            ...
            leftframea = Frame(topframe3a, bd=5, width=770, height=400, padx=2, bg="LightYellow4", relief=RIDGE)
            ...
            rightframe1a = Frame(topframe3a, bd=5, width=100, height=400, padx=2, bg="cadet blue", relief=RIDGE)
        ...
        nextb = Button(top, text="Customers", width=8, padx=4, pady=4, command=newwindow4, font=('Times', 15, 'bold'),bg="LightYellow2")
        nextb.place(relx=0.0, rely=0.2)
        BUTTONPRINT = Button(top, text="PRINT RECIEPT", width=15, padx=4, pady=4, font=('Times', 12, 'bold'), relief=RAISED,bg="LightYellow2",
                             command=newwindow1)
        BUTTONPRINT.place(relx=0.9, rely=0.85)


    else:
        labe = Label(frame1, text="Incorrect Username or Password", bg='LightYellow3')
...
# label username
usernamel = Label(frame1, text="Username", padx=5, pady=5, font=large_font1, bg='LightYellow3')
...
# label password
passwordl = Label(frame1, text="Password", padx=15, pady=15, font=large_font1, bg='LightYellow3')
